...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        evt_weight;
   ULong64_t       id[4];   //[evt_prt_count]
   Long64_t        pdg[4];   //[evt_prt_count]
   Double_t        trk_id[4];   //[evt_prt_count]
   Double_t        charge[4];   //[evt_prt_count]
   Double_t        dir_x[4];   //[evt_prt_count]
   Double_t        dir_y[4];   //[evt_prt_count]
   Double_t        dir_z[4];   //[evt_prt_count]
   Double_t        p[4];   //[evt_prt_count]
   Double_t        px[4];   //[evt_prt_count]
   Double_t        py[4];   //[evt_prt_count]
   Double_t        pz[4];   //[evt_prt_count]
   Double_t        tot_e[4];   //[evt_prt_count]
   Double_t        m[4];   //[evt_prt_count]
   Double_t        time[4];   //[evt_prt_count]
   Bool_t          is_beam[4];   //[evt_prt_count]
   Bool_t          is_stable[4];   //[evt_prt_count]
   Bool_t          gen_code[4];   //[evt_prt_count]
   ULong64_t       mother_id[4];   //[evt_prt_count]
   ULong64_t       mother_second_id[4];   //[evt_prt_count]
   Double_t        has_pol_info[4];   //[evt_prt_count]
   Double_t        pol_x[4];   //[evt_prt_count]
   Double_t        pol_y[4];   //[evt_prt_count]
   Double_t        pol_z[4];   //[evt_prt_count]
   Bool_t          has_vtx_info[4];   //[evt_prt_count]
   ULong64_t       vtx_id[4];   //[evt_prt_count]
   Double_t        vtx_x[4];   //[evt_prt_count]
   Double_t        vtx_y[4];   //[evt_prt_count]
   Double_t        vtx_z[4];   //[evt_prt_count]
   Double_t        vtx_t[4];   //[evt_prt_count]
   Bool_t          has_smear_info[4];   //[evt_prt_count]
   Bool_t          smear_has_e[4];   //[evt_prt_count]
   Bool_t          smear_has_p[4];   //[evt_prt_count]
   Bool_t          smear_has_pid[4];   //[evt_prt_count]
   Bool_t          smear_has_vtx[4];   //[evt_prt_count]
   Bool_t          smear_has_any_eppid[4];   //[evt_prt_count]
   Double_t        smear_orig_tot_e[4];   //[evt_prt_count]
   Double_t        smear_orig_p[4];   //[evt_prt_count]
   Double_t        smear_orig_px[4];   //[evt_prt_count]
   Double_t        smear_orig_py[4];   //[evt_prt_count]
   Double_t        smear_orig_pz[4];   //[evt_prt_count]
   Double_t        smear_orig_vtx_x[4];   //[evt_prt_count]
   Double_t        smear_orig_vtx_y[4];   //[evt_prt_count]
   Double_t        smear_orig_vtx_z[4];   //[evt_prt_count]
